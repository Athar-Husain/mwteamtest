...
import { Container, Box, Typography, Grid, TextField, Button, Paper, Avatar } from '@mui/material';
...
const index = () => {
  ...
  return (
    <>
      <Breadcrumbs links={[{ label: 'Dashboard', to: '/' }, { label: 'Profile' }]} divider />
          ...
          <Paper elevation={1} sx={{ p: 4 }}>
            <Grid container spacing={4}>
              ...
              <Grid size={{ xs: 12, md: 4 }}>
                ...
                >
                  <Avatar src={dummyData.image} alt="Profile" sx={{ width: 150, height: 150, mb: 2 }} />
